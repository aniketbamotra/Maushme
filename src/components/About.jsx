    ...
    <div className="about-review-subs col-span-full">
      <div className="about-wrapper flex justify-center lg:flex-nowrap lg:gap-0 gap-20 flex-wrap 2xl:pl-32 xl:px-20 md:px-10 px-8">
        <div className="content  lg:mt-14 lg:flex-1">
          ...
          <div className="btn-container flex gap-6">
            <div className="h-max atc-btn rounded-full w-max body xl:text-base text-sm font-medium xl:py-3 py-1 xl:px-6 px-3">Our Blog</div>
            <div className="atc-btn w-max h-max body xl:text-base text-sm font-medium xl:py-3 py-1 xl:px-6 px-3 rounded-full">
              Instagram
            </div>
          </div>
        </div>
        <div className="img-wrapper flex-1 relative">
            ...
            <img src={creator} alt="creator" className="absolute creator-img 2xl:w-80 xl:w-64 lg:w-48 sm:w-80 w-48" />
            <h5 className="body 2xl:pl-80 xl:pl-64 lg:pl-52 sm:pl-80 pl-52 text-sm md:mt-14 mt-6" >OUR CREATOR</h5>
            <h3 className="body 2xl:pl-80 xl:pl-64 lg:pl-52 sm:pl-80 pl-52 font-bold md:text-xl text-base" >ANNA SMITH</h3>
        </div>
      </div>
      <div className="review-wrapper flex lg:flex-nowrap flex-wrap-reverse justify-between lg:mt-32 mt-48 gap-20 2xl:px-32 xl:px-20 md:px-10 px-8">
        <div className="img-wrapper flex lg:w-max w-full justify-center">
            <img src={review1} alt="review1" className=" 2xl:w-96 xl:w-80 lg:w-60 sm:w-72 w-52 object-cover" />
            <img src={review2} alt="review2" className="2xl:w-96 xl:w-80 lg:w-60 sm:w-72 w-52 object-cover" />
        </div>
        <div className="content flex-1 ">
          <h6 className="body text-sm font-semibold">REVIEWS</h6>
          <h3 className="heading 2xl:text-4xl text-2xl 2xl:mt-7 mt-4">We adore all our friends at Maushme, especially the beauties who have come to live with us!
          </h3>
